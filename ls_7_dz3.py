...
# как написано в задании 2 (при помощи скрипта или «руками» в проводнике).
...
#    |      |--index.html
# Примечание:
# исходные файлы необходимо оставить; обратите внимание,
...
for path in files:
    folder_new = os.path.join(my_path, os.path.basename(os.path.dirname(path)))
